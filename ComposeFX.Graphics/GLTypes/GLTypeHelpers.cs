namespace ComposeFX.Graphics.GLTypes
{
    ...
    public static class GLTypeHelpers
    {
		...
		public static IEnumerable<GLStructField> GetGLStructFields (this Type type, string prefix)
        {
            ...
            if (!_structFields.TryGetValue (key, out IList<GLStructField> result))
            {
        ...
        public static DrawMode MapToDrawMode (this BeginMode beginMode)
        {
            switch (beginMode)
            {
                case BeginMode.Triangles: return DrawMode.Triangles;
                case BeginMode.TriangleStrip: return DrawMode.TriangleStrip;
                default: throw new ArgumentException ("Unsupported begin mode");
            }
        }
	}
}
