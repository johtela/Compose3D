...
namespace Compose3D.GLSL
{
    ...
    {
        public static V Add<V> (this V left, V right) where V : Vec<float>, new ()
        {
            var res = new V ();
        ...
        public static V Divide<V> (this V vec, float scalar) where V : Vec<float>, new ()
        {
            var res = new V ();
        ...
        public static V Negate<V> (this V vec) where V : Vec<float>, new ()
        {
            var res = new V ();
        ...
        public static V Multiply<V> (this V vec, float scalar) where V : Vec<float>, new ()
        {
            var res = new V ();
            vec.Vector.Map (res.Vector, a => a * scalar);
            return res;
        ...
        public static V Multiply<V> (this V vec, V scale) where V : Vec<float>, new ()
        {
            var res = new V ();
        ...
        public static V Subtract<V> (this V left, V right) where V : Vec<float>, new ()
        {
            var res = new V ();
            left.Vector.MapWith (right.Vector, res.Vector, (a, b) => a - b);
            return res;
